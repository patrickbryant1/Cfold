...
parser = argparse.ArgumentParser(description = """Predict using trained weights and a varying amount of sampled MSA clusters for more varied predictions.""")

parser.add_argument('--feature_dir', nargs=1, type= str, default=sys.stdin, help = 'Path to location of features.')
parser.add_argument('--predict_id', nargs=1, type= str, default=sys.stdin, help = 'Id to predict.')
parser.add_argument('--ckpt_params', nargs=1, type= str, default=sys.stdin, help = 'Params to start from.')
parser.add_argument('--num_recycles', nargs=1, type= int, default=sys.stdin, help = 'Number of recycles to use.')
parser.add_argument('--num_samples_per_cluster', nargs=1, type= int, default=sys.stdin, help = 'Number of samples to use per cluster selection.')
